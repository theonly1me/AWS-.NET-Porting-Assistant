                        ...
                        <div class="nav-bg">
                            <ul>
                                ...
                                <li><a href="#">Customer Support</a></li>
                                 <li style="float:right"> <asp:LinkButton ID="lnkSignOut" Text="Sign Out" 
                                         runat="server" onclick="lnkSignOut_Click1" 
                                 /></li>
                        ...
                        <div class="content-holder">
                            ...
                            <div class="ch-center">
                                ...
                                <div class="customer-feedback">
                                    <div class="cf-head">
                                        Coustomer Feedback</div>
                                    <div id="cont">
                                        <div class="mask1">
                                            <div id="box8">
                                                <div class="div1">
                                                    <h3>
                                                        Mr. Naba Kishore Mohanty</h3>
                                                    <p>
                                                        ...
                                                        I want go somewhere.</p>
                                                    <p class="buttons">
                                                        <span class="prev">&lt;&lt; Previous</span> <span class="next">Next &gt;&gt;</span></p>
                                                </div>
                                                <div class="div1">
                                                    <h3>
                                                        Abhinav Bhatnagar</h3>
                                                    <p>
                                                        <img src="images/customer-speak.jpg" align="left" />Unlike some booking websites
                                                        that show wrong information regarding seat availbility, Bus Teckets Online Booking
                                                        gives good information. I like booking through it and in fact I am using it whenever
