<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="WebForm1.aspx.cs" Inherits="OnlineBusTicket.WebForm1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        function NoResults() {
            ...
            alert("No of days left for the current month are not sufficient for bus plan.");
            return false;
                                    ...
                                    <tr>
                                        ...
                                        <td colspan="3">
                                            <asp:RadioButtonList ID="rbDays" runat="server" AutoPostBack="True" CssClass="readonlytext"
                                                ...
                                                OnSelectedIndexChanged="rbDays_SelectedIndexChanged" CausesValidation="True" 
                                                ValidationGroup="all">
