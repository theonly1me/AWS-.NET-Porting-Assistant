        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                if (!IsPostBack)
                {
                    ...
                    CommonUtility.getCity(ddl_source, "Location_Name", "Location_ID", "Eticket_MST_Location", "IsActive", "1");
                    CommonUtility.getCity(ddl_destin, "Location_Name", "Location_ID", "Eticket_MST_Location", "IsActive", "1");
                    ddl_source.Items.Insert(0, new ListItem("Select Source", "-1"));
                    ddl_destin.Items.Insert(0, new ListItem("Select Destination", "-1"));

                    DataTable dt = new DataTable();
                    dt= CommonUtility.getCityList("Location_Name", "Location_ID", "Eticket_MST_Location", "IsActive", "1");
